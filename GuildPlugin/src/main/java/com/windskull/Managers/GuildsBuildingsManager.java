...
public class GuildsBuildingsManager
{
	...
	public HashMap<String, GuildBuilding> guildsBuildings = new HashMap<>();
	...
	private GuildsBuildingsManager()
	{
		...
		ArrayList<ArrayList<GuildItem>> itemsforBuilding = new ArrayList<>();

		ArrayList<GuildItem> lv1 = new ArrayList<>();
	...
	public static GuildsBuildingsManager getInstance()
	{
		if (sing == null)
		{
			sing = new GuildsBuildingsManager();
		}
		return sing;
	}

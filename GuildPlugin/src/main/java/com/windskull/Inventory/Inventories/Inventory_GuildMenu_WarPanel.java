...
public class Inventory_GuildMenu_WarPanel extends Inventory_GuildMenu
{
	...
	{
		this.setItem(4, ItemsCreator.getItemStack(Material.GOLD_BLOCK,
			GuildsManager._ItemsColorNamePrimal + "MMR: " + GuildsManager._ItemsColorNameSecond + guildPlayer.getGuild().getMmr()));
	}

package com.windskull.Inventory.AnviGui.abstraction.src.main.java.net.wesjd.anvilgui.version;
...
public interface VersionWrapper {
     ...
     */
    void sendPacketOpenWindow(Player player, int containerId,String title);
     ...
     */
    Object newContainerAnvil(Player player,String containerTitle);
